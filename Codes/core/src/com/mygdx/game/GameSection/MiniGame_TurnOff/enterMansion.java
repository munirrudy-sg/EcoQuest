...
public class enterMansion extends TriggerEvent {
    private Image blackScreen;
    private float nextXpos;
    private float nextYpos;
    private Label instructionLabel;

    public enterMansion(Player player, String texture, int width, int height, float xPos, float yPos, float nextXpos, float nextYpos) {
    ...
    public void OnTriggerExit() {
        GameWorld.LampCounter.showLampCounter(false);
        instructionLabel.setVisible(false);
    }
}
